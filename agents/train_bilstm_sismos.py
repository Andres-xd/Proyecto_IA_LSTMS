...
MODEL_PATH = MODELS_DIR / "model_bilstm_sismos.pth"

INPUT_SIZE  = 5
HIDDEN_SIZE = 64       # x2 efectivo por bidireccional = 128
DROPOUT     = 0.2
BATCH_SIZE  = 32
EPOCHS      = 100
LR          = 0.001
...
class BiLSTMSismos(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(
            ...
            batch_first=True, bidirectional=True   # ← clave
        )
        self.dropout = nn.Dropout(DROPOUT)
        # bidireccional duplica la salida: hidden_size * 2
