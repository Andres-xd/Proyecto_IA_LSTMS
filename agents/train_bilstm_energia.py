...
MODEL_PATH = MODELS_DIR / "bilstm_energia.pth"
META_PATH  = MODELS_DIR / "bilstm_energia.json"
...
class BiLSTMEnergia(nn.Module):
    def __init__(self):
        ...
        # Salida del LSTM bidireccional tiene tamaño 2*HIDDEN_SIZE
...
def main():
    print("=" * 60)
    print("  ENTRENAMIENTO BIDIRECTIONAL LSTM — Energía Eléctrica")
